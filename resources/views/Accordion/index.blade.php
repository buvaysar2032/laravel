...
@section('content')
    <div class="row">
        ...
        <div class="col-12 text-right mb-3">
            <a href="{{ route('accordions.create') }}" class="btn btn-success btn-sm">Create</a>
        </div>
        <div class="col-12">
            @if (session('success'))
                                ...
                                @foreach ($accordions as $accordion)
                                    <tr>
                                        ...
                                        <td class="d-flex justify-content-center align-items-center" style="gap: 15px">
                                            ...
                                            <a href="{{ route('accordions.show', $accordion->id) }}"
                                                class="btn btn-primary btn-sm">Show</a>
                                            <a href="{{ route('accordions.edit', $accordion->id) }}"
